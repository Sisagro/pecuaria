...
<fieldset>
    <?php
    echo $this->Form->input('eventomelhoracampo_id', array ('id' => 'melhoracampoID', 'type' => 'select', 'options' => $melhoracampos, 'label' => 'Melhoramento de campo', 'empty' => '-- Selecione o melhoramento de campo --', 'value' => ''));
...
$this->Js->get('#loteID')->event(
    'change',
    $this->Js->request(
        array('controller' => 'Categorias', 'action' => 'buscaCategoriasLotes', 'Alimentacao'),
...
$this->Js->get('#melhoracampoID')->event(
    'change',
    $this->Js->request(
        array('controller' => 'Eventomelhoracampos', 'action' => 'buscaEventomelhoracampos', 'Alimentacao'),
        array(  'update' => '#eventomelhoracampoID',
                'async' => true,
		'method' => 'post',
		'dataExpression'=>true,
		'data'=> $this->Js->serializeForm(array(
    ...
    jQuery(document).ready(function(){
        ...
        $("#categoriaID").change( function(){
            $.ajax({async:true, 
                    ...
                    type:"post",
                    url:"\/pecuaria/categorialotes\/buscaId\/Alimentacao\/" + $("#loteID option:selected").val()
            });
        });
        ...
        $("#categoriaID").change( function(){
            $.ajax({async:true, 
                    ...
                    type:"post",
                    url:"\/pecuaria/Categorialotes\/buscaAnimaisLote\/Alimentacao\/" + $("#loteID option:selected").val()
            });
        });
